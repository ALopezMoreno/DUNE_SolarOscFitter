...
- **CC background ×10 factor** (`backgrounds.jl`): CC MC is normalised to 1 kt-year; the factor of 10 scales to the 10 kt-year analysis exposure. Update if the target exposure changes.
