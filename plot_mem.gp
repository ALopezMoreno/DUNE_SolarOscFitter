...
plot "memory_usage_6k_fix1.log" using 0:($3/1024) with lines title "6K batch size fix1" lc rgb "green", "memory_usage.log" using 0:($3/1024) with lines title "1K batch size", \
 "memory_usage_6k.log" using 0:($3/1024) with lines title "6K batch size" lc rgb "gold", "memory_usage_6k_fix2.log" using 0:($3/1024) with lines title "6K batch size" lc rgb "red"
